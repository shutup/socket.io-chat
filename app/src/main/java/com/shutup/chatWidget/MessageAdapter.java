    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (message.getType()) {
            ...
            case 1://photo
                ...
                //TODO set image
                int id = context.getResources().getIdentifier(message.getContent(), "mipmap", context.getPackageName());
            ...
            case 2://face
                ...
                int resId = context.getResources().getIdentifier(message.getContent(), "mipmap", context.getPackageName());
